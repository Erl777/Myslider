...
class Slider {
    ...
    method1() {
        ...
        if (this.buttons === true){
            ...
            slider.insertAdjacentHTML('beforeEnd', svg_l);
            slider.insertAdjacentHTML('beforeEnd', svg_r);
