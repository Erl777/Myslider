...
class Slider {
    ...
    method1 () {
        ...
        if (this.settings.buttons === true){
            ...
            if( this.settings.vertical === true){
                right.addEventListener('click', this.move_top);
            }
            else {
            ...
            if( this.settings.vertical === true){
                left.addEventListener('click', this.move_down);
            }
            else {
    ...
    move = (direction) => {
        console.log('Move work ' + direction );
        console.log(this);
        if (direction === 'left' || direction === 'down') this.count--;
        if (direction === 'right' || direction === 'up') this.count++;
